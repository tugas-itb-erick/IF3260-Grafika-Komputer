all: src/1-titik/main.c src/2-garis/main.cpp src/2-garis/models/Color.cpp src/2-garis/models/Point.cpp src/2-garis/models/Line.cpp src/2-garis/models/CharDrawable.cpp src/3-bidang/main.cpp src/3-bidang/models/Color.cpp src/3-bidang/models/Point.cpp src/3-bidang/models/Line.cpp src/3-bidang/models/Triangle.cpp src/3-bidang/models/CharDrawable.cpp src/4-transformasi/main.cpp src/4-transformasi/models/Color.cpp src/4-transformasi/models/Point.cpp src/4-transformasi/models/Line.cpp src/4-transformasi/models/Triangle.cpp src/4-transformasi/models/Drawable.cpp src/4-transformasi/models/Buffer.cpp src/5-window/main.cpp src/5-window/models/Color.cpp src/5-window/models/Point.cpp src/5-window/models/Line.cpp src/5-window/models/Triangle.cpp src/5-window/models/Drawable.cpp src/5-window/models/Buffer.cpp src/6-peta/main.cpp src/6-peta/models/Color.cpp src/6-peta/models/Point.cpp src/6-peta/models/Line.cpp src/6-peta/models/Triangle.cpp src/6-peta/models/Drawable.cpp src/6-peta/models/Buffer.cpp
	[ -d bin ] || mkdir -p bin
